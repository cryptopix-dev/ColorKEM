 ...
 * optimal SIMD acceleration for cryptographic operations. The ColorKEM
...
/** @brief SIMD instruction set support levels */
 ...
 * This allows ColorKEM to automatically select the most efficient
