 ...
 * compatible with WebP format like ColorSign, and decode back. Keys are serialized
 * as byte arrays where each 4 bytes represent a ColorValue coefficient, and the
